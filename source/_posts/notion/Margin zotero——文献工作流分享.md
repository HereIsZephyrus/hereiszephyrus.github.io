...
tags:
  ...
  - Workflow
  - Zotero
updated: 2025-05-10T07:03:00+00:00
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/zotero_connector.png)
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/data_dictionary_setting.png)
...
• View your iCloud calendars and contacts with classic Outlook.
...
由于我们用的不是 zotero 的官方同步方式,因此需要一个插件辅助我们进行管理.进入 ZotFile 的 GitHub 主页可以下载插件.xpi 文件然后在 zotero 中安装(看相关教程).ZotFile 可以将从浏览器中下载的 pdf 文件自动重命名(如 author_year_title.pdf)并放入我们建立好的云盘目录内,并将对应的附件链接添加到文献条目中.
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/zotfile_setting.png)
...
![在side-bar中可以非常快捷地查看](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/scihub_plugin.png)
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/totallist_display.png)
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/raw_readinglist_output.png)
...
![编译后结果](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/markdown_convert_output.png)
...
![](https://cdn.jsdelivr.net/gh/HereIsZephyrus/zephyrus.img/images/blog/beamer_convert_output.png)
